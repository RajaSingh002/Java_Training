...
public class Example {
    ...
    //    Matcher matcher= pattern.matcher("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaab");
    ...
    //    System.out.println(ans);
        ...
        String helloWorld3 = Example.format("%s %s", "Hello", "World");
        System.out.println("Using Example.format: " + helloWorld3);
